...
import { GeminiVideoClient } from './video-client.js';
...
export { GeminiVideoClient, buildTurnRequest, ensureImageTag, mapInteraction } from './video-client.js';
export type { GenAiLike } from './genai.js';

export function createVideoClient(config: AppConfig, logger: Logger, media: MediaTools): VideoModelClient {
  ...
  return new GeminiVideoClient({ config, logger });
}
